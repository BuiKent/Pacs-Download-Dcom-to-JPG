...
const PAIRS = [
  ...
  ["--stage-active-fg", "--stage-active-bg", "the treatment-in-progress badge on a patient row"],
  ["--stage-postop-fg", "--stage-postop-bg", "the post-operative badge on a patient row"],
  ["--stage-followup-fg", "--stage-followup-bg", "the follow-up badge on a patient row"],
  ["--stage-relapse-fg", "--stage-relapse-bg", "the relapse badge on a patient row"],
  ["--stage-stale-fg", "--stage-stale-bg", "a treatment badge nobody has updated"],
