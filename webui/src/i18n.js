...
export const EN = {
  ...
  "{} (độ {})": "{} (grade {})",
  "Độ {}": "Grade {}",
  // The grade field against a diagnosis WHO CNS5 gives no grade.
  "Không xếp độ": "Not graded",
...
export const CLINICAL_EN = {
  ...
  // The families the diagnosis list is grouped into: the chapters and
  // sub-families of the WHO CNS5 book, in its order.
  "U thần kinh đệm lan toả kiểu người lớn": "Adult-type diffuse gliomas",
  "U thần kinh đệm lan toả độ thấp kiểu trẻ em": "Paediatric-type diffuse low-grade gliomas",
  "U thần kinh đệm lan toả độ cao kiểu trẻ em": "Paediatric-type diffuse high-grade gliomas",
  "U thần kinh đệm dạng sao khu trú": "Circumscribed astrocytic gliomas",
  "U thần kinh đệm - thần kinh và u thần kinh": "Glioneuronal and neuronal tumours",
  "Các u màng não thất": "Ependymal tumours",
  "Các u đám rối mạch mạc": "Choroid plexus tumours",
  "Các u nguyên bào tuỷ": "Medulloblastomas",
  "Các u phôi khác": "Other CNS embryonal tumours",
  "U vùng tuyến tùng": "Pineal tumours",
  "U thần kinh sọ và cạnh sống": "Cranial and paraspinal nerve tumours",
  "Các u màng não": "Meningiomas",
  "U trung mô không phải màng não": "Mesenchymal, non-meningothelial tumours",
  "U tế bào hắc tố": "Melanocytic tumours",
  "Các u lympho": "Lymphomas",
  "U mô bào": "Histiocytic tumours",
  "Các u tế bào mầm": "Germ cell tumours",
  "U vùng hố yên": "Tumours of the sellar region",
  "Di căn thần kinh trung ương": "Metastases to the CNS",
  "Nang và tổn thương dạng u (ngoài phân loại WHO)":
    "Cysts & tumour-like lesions (outside the WHO classification)",
  // The heading the marker panel files the glioma markers under.
  "U thần kinh đệm": "Gliomas",

  // WHO CNS5 type names, spelled as the book spells them. English is the
  // nomenclature these were written in, so it is the name a report, a
  // guideline and a tumour board all use.
  ...
  "U sao bào lan toả, biến đổi MYB hoặc MYBL1": "Diffuse astrocytoma, MYB- or MYBL1-altered",
  "U thần kinh đệm quanh mạch": "Angiocentric glioma",
  ...
  "U thần kinh đệm lan toả đường giữa, H3 K27 thay đổi": "Diffuse midline glioma, H3 K27-altered",
  "U thần kinh đệm lan toả bán cầu, H3 G34 đột biến": "Diffuse hemispheric glioma, H3 G34-mutant",
  ...
  "U thần kinh đệm bán cầu kiểu nhũ nhi": "Infant-type hemispheric glioma",
  "U sao bào lông": "Pilocytic astrocytoma",
  "U sao bào độ cao có đặc điểm dạng lông": "High-grade astrocytoma with piloid features (HGAP)",
  "U sao bào vàng đa hình": "Pleomorphic xanthoastrocytoma (PXA)",
  "U sao bào dưới màng não thất tế bào khổng lồ": "Subependymal giant cell astrocytoma (SEGA)",
  "U thần kinh đệm dạng dây sống": "Chordoid glioma",
  "U nguyên bào sao, biến đổi MN1": "Astroblastoma, MN1-altered",
  ...
  "U thần kinh đệm - thần kinh dạng nhú": "Papillary glioneuronal tumour",
  "U thần kinh đệm - thần kinh tạo hoa hồng": "Rosette-forming glioneuronal tumour",
  "U thần kinh đệm - thần kinh dạng nhầy": "Myxoid glioneuronal tumour",
  "U thần kinh đệm - thần kinh lan toả màng mềm":
    "Diffuse leptomeningeal glioneuronal tumour (DLGNT)",
  "U tế bào thần kinh đa nốt và không bào": "Multinodular and vacuolating neuronal tumour (MVNT)",
  "U tế bào hạch loạn sản tiểu não (bệnh Lhermitte-Duclos)":
    "Dysplastic cerebellar gangliocytoma (Lhermitte-Duclos disease)",
  "U tế bào thần kinh trung ương": "Central neurocytoma",
  "U tế bào thần kinh ngoài não thất": "Extraventricular neurocytoma",
  "U tế bào thần kinh mỡ tiểu não": "Cerebellar liponeurocytoma",
  "U màng não thất": "Ependymoma",
  "U màng não thất trên lều": "Supratentorial ependymoma",
  "U màng não thất trên lều, dung hợp ZFTA": "Supratentorial ependymoma, ZFTA fusion-positive",
  "U màng não thất trên lều, dung hợp YAP1": "Supratentorial ependymoma, YAP1 fusion-positive",
  "U màng não thất hố sau": "Posterior fossa ependymoma",
  "U màng não thất hố sau nhóm A (PFA)": "Posterior fossa group A (PFA) ependymoma",
  "U màng não thất hố sau nhóm B (PFB)": "Posterior fossa group B (PFB) ependymoma",
  "U màng não thất tuỷ sống": "Spinal ependymoma",
  "U màng não thất tuỷ sống, khuếch đại MYCN": "Spinal ependymoma, MYCN-amplified",
  "U màng não thất nhú nhầy": "Myxopapillary ependymoma",
  ...
  "U nhú đám rối mạch mạc không điển hình": "Atypical choroid plexus papilloma",
  "Ung thư biểu mô đám rối mạch mạc": "Choroid plexus carcinoma",
  "U nguyên bào tuỷ": "Medulloblastoma",
  "U nguyên bào tuỷ, hoạt hoá WNT": "Medulloblastoma, WNT-activated",
  "U nguyên bào tuỷ, hoạt hoá SHH và TP53 tự nhiên":
    "Medulloblastoma, SHH-activated and TP53-wildtype",
  "U nguyên bào tuỷ, hoạt hoá SHH và TP53 đột biến":
    "Medulloblastoma, SHH-activated and TP53-mutant",
  "U nguyên bào tuỷ, không WNT/không SHH": "Medulloblastoma, non-WNT/non-SHH",
  "U nguyên bào tuỷ, xác định theo mô học": "Medulloblastoma, histologically defined",
  "U quái không điển hình/dạng cơ vân": "Atypical teratoid/rhabdoid tumour (ATRT)",
  "U biểu mô thần kinh dạng sàng": "Cribriform neuroepithelial tumour (CRINET)",
  "U phôi có hoa hồng nhiều lớp": "Embryonal tumour with multilayered rosettes (ETMR)",
  "U nguyên bào thần kinh TKTW, hoạt hoá FOXR2": "CNS neuroblastoma, FOXR2-activated",
  "U TKTW có lặp đoạn nội tại BCOR": "CNS tumour with BCOR internal tandem duplication",
  "U phôi TKTW, NEC/NOS": "CNS embryonal tumour, NEC/NOS",
  ...
  "U nhú vùng tuyến tùng": "Papillary tumour of the pineal region (PTPR)",
  ...
  "U tế bào quanh bó thần kinh": "Perineurioma",
  "U bao dây thần kinh lai": "Hybrid nerve sheath tumour",
  "U bao dây thần kinh hắc tố ác tính": "Malignant melanotic nerve sheath tumour",
  "U bao dây thần kinh ngoại biên ác tính": "Malignant peripheral nerve sheath tumour (MPNST)",
  "U thần kinh nội tiết đuôi ngựa": "Cauda equina neuroendocrine tumour (previously paraganglioma)",
  "U màng não": "Meningioma",
  "U xơ đơn độc": "Solitary fibrous tumour",
  "U mạch máu mao mạch": "Capillary haemangioma",
  ...
  "Sarcôm tái sắp xếp CIC": "CIC-rearranged sarcoma",
  "Sarcôm nội sọ nguyên phát, đột biến DICER1": "Primary intracranial sarcoma, DICER1-mutant",
  "Sarcôm Ewing": "Ewing sarcoma",
  "Sarcôm sụn trung mô": "Mesenchymal chondrosarcoma",
  "Sarcôm sụn": "Chondrosarcoma",
  "U dây sống": "Chordoma",
  "Bệnh tế bào hắc tố màng não": "Meningeal melanocytosis",
  "Bệnh hắc tố ác tính lan toả màng não": "Meningeal melanomatosis",
  "U tế bào hắc tố màng não": "Meningeal melanocytoma",
  "U hắc tố ác tính màng não": "Meningeal melanoma",
  "U lympho thần kinh trung ương nguyên phát":
    "Primary diffuse large B-cell lymphoma of the CNS (PCNSL)",
  "U lympho TKTW liên quan suy giảm miễn dịch": "Immunodeficiency-associated CNS lymphoma",
  "U hạt dạng lympho": "Lymphomatoid granulomatosis",
  "U lympho tế bào B lớn nội mạch": "Intravascular large B-cell lymphoma",
  "U lympho MALT màng cứng": "MALT lymphoma of the dura",
  "U lympho tế bào B độ thấp khác của TKTW": "Other low-grade B-cell lymphomas of the CNS",
  "U lympho tế bào lớn kém biệt hoá (ALK+/ALK-)": "Anaplastic large cell lymphoma (ALK+/ALK-)",
  "U lympho tế bào T và NK/T": "T-cell and NK/T-cell lymphomas",
  "Bệnh Erdheim-Chester": "Erdheim-Chester disease",
  "Bệnh Rosai-Dorfman": "Rosai-Dorfman disease",
  "U hạt vàng thiếu niên": "Juvenile xanthogranuloma",
  ...
  "U quái có ác tính hoá kiểu thân thể": "Teratoma with somatic-type malignancy",
  ...
  "U sọ hầu thể men răng": "Adamantinomatous craniopharyngioma",
  "U sọ hầu thể nhú": "Papillary craniopharyngioma",
  "U tế bào tuyến yên thần kinh": "Pituicytoma",
  "U tế bào hạt vùng hố yên": "Granular cell tumour of the sellar region",
  "U tế bào ưa toan hình thoi": "Spindle cell oncocytoma",
  "U tuyến yên": "Pituitary adenoma / pituitary neuroendocrine tumour (PitNET)",
  "U nguyên bào tuyến yên": "Pituitary blastoma",
  "U di căn": "Metastasis",
  "Di căn nhu mô não và tuỷ sống": "Metastases to the brain and spinal cord parenchyma",
  "Di căn màng não - tuỷ": "Metastases to the meninges",
